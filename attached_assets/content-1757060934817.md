...
[Open in GitHub](https://github.com/openai/openai-cookbook/blob/main/examples/evaluation/use-cases/bulk-experimentation.ipynb) [View as Markdown](https://nbviewer.org/format/script/github/openai/openai-cookbook/blob/main/examples/evaluation/use-cases/bulk-experimentation.ipynb)
...
## [Evals structure](https://cookbook.openai.com/examples/evaluation/use-cases/bulk-experimentation\#evals-structure)
...
## [Use-case](https://cookbook.openai.com/examples/evaluation/use-cases/bulk-experimentation\#use-case)
...
# [Setting up your eval](https://cookbook.openai.com/examples/evaluation/use-cases/bulk-experimentation\#setting-up-your-eval)
...
# [Creating runs](https://cookbook.openai.com/examples/evaluation/use-cases/bulk-experimentation\#creating-runs)
...
## [Congratulations, you just tested 9 different prompt and model variations across your dataset!](https://cookbook.openai.com/examples/evaluation/use-cases/bulk-experimentation\#congratulations-you-just-tested-9-different-prompt-and-model-variations-across-your-dataset)
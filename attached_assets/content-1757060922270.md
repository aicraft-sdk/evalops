...
[Open in GitHub](https://github.com/openai/openai-cookbook/blob/main/examples/evaluation/use-cases/regression.ipynb) [View as Markdown](https://nbviewer.org/format/script/github/openai/openai-cookbook/blob/main/examples/evaluation/use-cases/regression.ipynb)
...
## [Evals structure](https://cookbook.openai.com/examples/evaluation/use-cases/regression\#evals-structure)
...
## [Use-case](https://cookbook.openai.com/examples/evaluation/use-cases/regression\#use-case)
...
# [Setting up your eval](https://cookbook.openai.com/examples/evaluation/use-cases/regression\#setting-up-your-eval)
...
# [Creating runs](https://cookbook.openai.com/examples/evaluation/use-cases/regression\#creating-runs)
...
## [Congratulations, you just prevented a bug from shipping to users](https://cookbook.openai.com/examples/evaluation/use-cases/regression\#congratulations-you-just-prevented-a-bug-from-shipping-to-users)

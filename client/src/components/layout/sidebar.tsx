...
import { CheckCircle, LayoutDashboard, TrendingUp, Archive, ClipboardList, Zap, Shield, FileText, Moon, Sun, Database, Menu, X, Settings, Code, ChevronDown, ChevronRight, DollarSign, Package, Users, Cpu } from "lucide-react";

...
export const azureSubscriptions = pgTable(
  'azure_subscriptions',
  {
    id: varchar('id')
      .primaryKey()
...
export const azureMLWorkspaces = pgTable(
  'azure_ml_workspaces',
  {
    id: varchar('id')
      .primaryKey()
      .default(sql`gen_random_uuid()`),
    azureSubscriptionId: varchar('azure_subscription_id')
      .notNull()
...
export const azureDeployments = pgTable(
  'azure_deployments',
  {
    id: varchar('id')
      .primaryKey()
      .default(sql`gen_random_uuid()`),
    azureWorkspaceId: varchar('azure_workspace_id')
      .notNull()
      .references(() => azureMLWorkspaces.id),
...
export const azurePromptFlows = pgTable(
  'azure_prompt_flows',
  {
    id: varchar('id')
      .primaryKey()
...
export const azureOpenAIAccounts = pgTable(
...
export const azureOpenAIDeployments = pgTable(
  'azure_openai_deployments',
  {
    id: varchar('id')
      .primaryKey()
      .default(sql`gen_random_uuid()`),
    azureOpenAIAccountId: varchar('azure_openai_account_id')
      .notNull()
      .references(() => azureOpenAIAccounts.id),
    deploymentName: varchar('deployment_name').notNull(),
...
export const insertAzureSubscriptionSchema = (
  createInsertSchema(azureSubscriptions) as any
).omit({
  id: true,
  createdAt: true,
  updatedAt: true,
});
export type InsertAzureSubscription = z.infer<
  typeof insertAzureSubscriptionSchema
>;

export type AzureMLWorkspace = typeof azureMLWorkspaces.$inferSelect;
export const insertAzureMLWorkspaceSchema = (
  createInsertSchema(azureMLWorkspaces) as any
).omit({
  id: true,
  createdAt: true,
  updatedAt: true,
});
export type InsertAzureMLWorkspace = z.infer<
  typeof insertAzureMLWorkspaceSchema
>;

export type AzureDeployment = typeof azureDeployments.$inferSelect;
export const insertAzureDeploymentSchema = (
  createInsertSchema(azureDeployments) as any
).omit({
  id: true,
  createdAt: true,
  updatedAt: true,
...
export const insertAzurePromptFlowSchema = (
  createInsertSchema(azurePromptFlows) as any
).omit({
  id: true,
  createdAt: true,
  updatedAt: true,
...
export const insertAzureOpenAIAccountSchema = (
  createInsertSchema(azureOpenAIAccounts) as any
).omit({
  id: true,
  createdAt: true,
  updatedAt: true,
});
export type InsertAzureOpenAIAccount = z.infer<
  typeof insertAzureOpenAIAccountSchema
>;

export type AzureOpenAIDeployment = typeof azureOpenAIDeployments.$inferSelect;
export const insertAzureOpenAIDeploymentSchema = (
  createInsertSchema(azureOpenAIDeployments) as any
).omit({
  id: true,
  createdAt: true,
  updatedAt: true,
});
export type InsertAzureOpenAIDeployment = z.infer<
  typeof insertAzureOpenAIDeploymentSchema
>;

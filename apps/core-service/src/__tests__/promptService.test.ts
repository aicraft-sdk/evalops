/* eslint-disable */
// @ts-nocheck
// TODO: rewire for NestJS DI — PromptsService is now an @Injectable() class in
// apps/core-service/src/app/prompts/prompts.service.ts; storage calls are now
// injected via DatabaseStorageService. Use NestJS TestingModule to rewire.
// Equivalent functional export (promptService) no longer exists post-migration.

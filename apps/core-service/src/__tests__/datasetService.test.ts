/* eslint-disable */
// @ts-nocheck
// TODO: rewire for NestJS DI — DatasetsService is now an @Injectable() class in
// apps/core-service/src/app/datasets/datasets.service.ts; storage calls are now
// injected via DatabaseStorageService. Use NestJS TestingModule to rewire.
// Equivalent functional export (datasetService) no longer exists post-migration.

describe.skip('DatasetService', () => {
  beforeEach(() => {
    jest.clearAllMocks();
  });

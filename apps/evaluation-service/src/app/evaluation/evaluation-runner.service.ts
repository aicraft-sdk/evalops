...
import { type EvaluationResult } from './evaluation.service';
...
/**
 * Handles per-sample evaluation logic extracted from EvaluationService.
 * Responsible for: response generation, evaluator dispatch, code detection/execution.
 */
@Injectable()
export class EvaluationRunnerService {
  ...
  async evaluateSample(
    ...
    try {
      ...
      // Run evaluators
      const evaluatorList = (evalSpec['evaluators'] as EvaluatorSpec[] | undefined) || [];

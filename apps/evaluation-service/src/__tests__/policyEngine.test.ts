/* eslint-disable */
// @ts-nocheck
// TODO: rewire for NestJS DI — PoliciesService is now an @Injectable() class in
// apps/evaluation-service/src/app/policies/policies.service.ts; storage calls are
// now injected via DatabaseStorageService. The functional policyEngine export and
// storage module no longer exist post-migration. Use NestJS TestingModule to rewire.
// PolicyRule type is still exported from policies.service.ts at the new path.

/* eslint-disable */
// @ts-nocheck
// TODO: rewire for NestJS DI — AIProviderService is now an @Injectable() class in
// apps/evaluation-service/src/app/ai-provider/ai-provider.service.ts; the
// functional azureOpenAIAdapter export no longer exists post-migration.
// Use NestJS TestingModule with ConfigService mock to rewire.

describe.skip('AzureOpenAIAdapter', () => {
